...
class HelloWidget extends React.Component{
  ...
  main(){
              ...
              debugger
              var validMeManager = this.props.validMeManager;
              ...
              validMeManager.validMeQueue.push((element, props) => { //add this validation item to the global queue
              ...
              validMeManager.validMeQueue[index].element = element;
              ...
              validMeManager.validMeQueue[index].toggleError = validMeManager.validMeQueue[index].showError = function() {
                var el = validMeManager.validMeQueue[index.toString()].element
                if (!angular.isUorN(validMeManager.validMeQueue[index].props.validmeselectthirdparent))
                  possibleLabel = el.parent().parent().parent().find("label:first");
                else if (!angular.isUorN(validMeManager.validMeQueue[index].props.validmeselectfourthparent))
              ...
              validMeManager.validMeQueue[index].validmeaction = props.validmeaction != undefined ? props.validmeaction : "";
              validMeManager.validMeQueue[index].errorTemplate = '<div ng-show="validMeManager.validMeQueue[' + index.toString() + '].errorActionVisible" class="error-label"><label style="text-align:left" class="error-color control-label bold" ng-cloak>{{errorMessage' + index.toString() + '}}</label></div>';
              validMeManager.validMeQueue[index].errorCheckmarkTemplate = '<i ng-click="validMeManager.validMeQueue[' + index.toString() + '].toggleError()" class="warning big circle icon error-checkmark"></i>';

              window.validMeManager = validMeManager;
              ...
              function codeInjector(validMeAction) {
                ...
                if (typeof(validMeAction) === 'function') {
                  ...
                  if (validMeManager.validMeActionPreExecution == undefined) { //do not create the same unbiding/validation-triggering function twice
                    ...
                    validMeManager.validMeActionPreExecution = function(event, parameters) {
                    ...
                    debugger
                    var name =  "functionWrapper" + this.functionName(validMeAction);
              ...
              angular.forEach(props.validmeaction.split('@'), codeInjector)
